...
public class GuideHelpTaskInfo {
	...
	/**引导指向的view，相对位置控制(大体定位)，当没有设置时，纵向由绝对位置topShowY和bottomShowY控制*/
	public View attachView;
	/**纵向显示位置topShowY优先，bottomShowY次之，这是绝对位置， 当不设置attachView时生效*/
	/**控制垂直方向的显示位置*/
	public int topShowY;
	/**控制垂直方向的显示位置*/
	public int bottomShowY;
	/**
	 * guideView边距控制(微调),用于控制水平方向的位置,优先级leftMargin > rightMargin
	 * */
	public int leftMargin;
	public int rightMargin;
	/**
	 * guideView边距控制(微调),用于微调位置,优先级topMargin > bottomMargin
	 * */
